...
func VP8InitRandom(*VP8Random const rg, float dithering) {
  ...
  rg.amp = (dithering < 0.0) ? 0
            : (dithering > 1.0)
                ...
                : (uint32)((1 << VP8_RANDOM_DITHER_FIX) * dithering);
}
