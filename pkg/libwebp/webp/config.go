...
func WebPConfigPreset(config *WebPConfig, preset WebPPreset, quality float64) int {
	return WebPConfigInitInternal(config, preset, quality, WEBP_ENCODER_ABI_VERSION)
}

// Internal, version-checked, entry point
func WebPConfigInitInternal(config *WebPConfig, preset WebPPreset, quality float64, version int) int {
