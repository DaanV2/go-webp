...
const NUM_TYPES = vp8.NUM_TYPES
const NUM_BANDS = vp8.NUM_BANDS
const NUM_CTX = vp8.NUM_CTX
const NUM_PROBAS = vp8.NUM_PROBAS
...
func VP8ResetProba( /* const */ proba *VP8Proba) {
	stdlib.Memset(proba.segments, uint(255), sizeof(proba.segments))
...
func ParseIntraMode( /* const */ br *VP8BitReader /*const*/, dec *VP8Decoder, mb_x int) {
	...
	if dec.use_skip_proba {
		block.skip = VP8GetBit(br, dec.skip_p, "skip")
	}
