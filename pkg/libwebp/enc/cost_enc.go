...
// context (in [][1]).
var VP8LevelCodes = [MAX_VARIABLE_LEVEL][2]uint16{
...
func VP8RecordStats(bit int, stats *proba_t) int {
	var p proba_t = *stats
...
func VP8BitCost(bit int, uint8 proba) int {
	return tenary.If(!(bit != 0), VP8EntropyCost[proba], VP8EntropyCost[255-proba])
}
