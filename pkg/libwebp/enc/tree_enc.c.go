...
static int PutI4Mode(/* const */ bw *VP8BitWriter, int mode, /*const*/ prob *uint8) {
...
func PutI16Mode(/* const */ bw *VP8BitWriter, int mode) {
...
func PutUVMode(/* const */ bw *VP8BitWriter, int uv_mode) {
