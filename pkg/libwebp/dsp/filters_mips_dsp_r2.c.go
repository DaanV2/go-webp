...
static  func PredictLine_MIPSdspR2(const uint8* WEBP_RESTRICT src,
...
static  func DoHorizontalFilter_MIPSdspR2(
    const uint8* WEBP_RESTRICT in, int width, int height, int stride,
...
func HorizontalFilter_MIPSdspR2(const uint8* WEBP_RESTRICT data,
...
func VerticalFilter_MIPSdspR2(const uint8* WEBP_RESTRICT data,
                                     int width, int height, int stride,
                                     uint8* WEBP_RESTRICT filtered_data) {
...
func DoGradientFilter_MIPSdspR2(const uint8* WEBP_RESTRICT in,
                                       int width, int height, int stride,
                                       uint8* WEBP_RESTRICT out) {
  const uint8* preds = in;
  int row;
...
func GradientFilter_MIPSdspR2(const uint8* WEBP_RESTRICT data,
                                     int width, int height, int stride,
                                     uint8* WEBP_RESTRICT filtered_data) {
