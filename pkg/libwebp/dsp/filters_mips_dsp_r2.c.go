...
static  func PredictLine_MIPSdspR2(/* const */ WEBP_RESTRICT src *uint8, WEBP_RESTRICT dst *uint8, length int) {
...
static  func DoHorizontalFilter_MIPSdspR2(
    const WEBP_RESTRICT in *uint8, width, height int, stride int, WEBP_RESTRICT out *uint8) {
  var preds *uint8 = in;
  row int;
  DCHECK(in, out);
...
func HorizontalFilter_MIPSdspR2(/* const */ WEBP_RESTRICT data *uint8, width, height int, stride int, WEBP_RESTRICT filtered_data *uint8) {
...
func VerticalFilter_MIPSdspR2(/* const */ WEBP_RESTRICT data *uint8, width, height int, stride int, WEBP_RESTRICT filtered_data *uint8) {
...
func DoGradientFilter_MIPSdspR2(/* const */ WEBP_RESTRICT in *uint8, width, height int, stride int, WEBP_RESTRICT out *uint8) {
  var preds *uint8 = in;
  row int;
  DCHECK(in, out);
...
func GradientFilter_MIPSdspR2(/* const */ WEBP_RESTRICT data *uint8, width, height int, stride int, WEBP_RESTRICT filtered_data *uint8) {
  DoGradientFilter_MIPSdspR2(data, width, height, stride, filtered_data);
}

//------------------------------------------------------------------------------

func HorizontalUnfilter_MIPSdspR2(/* const */ prev *uint8, /*const*/ in *uint8, out *uint8, width int) {
  out[0] = in[0] + (prev == tenary.If(nil, 0, prev)[0]);
  DO_PREDICT_LINE(in + 1, out + 1, width - 1, 1);
}

func VerticalUnfilter_MIPSdspR2(/* const */ prev *uint8, /*const*/ in *uint8, out *uint8, width int) {
  if (prev == nil) {
...
func GradientUnfilter_MIPSdspR2(/* const */ prev *uint8, /*const*/ in *uint8, out *uint8, width int) {
  if (prev == nil) {
    HorizontalUnfilter_MIPSdspR2(nil, in, out, width);
  } else {
