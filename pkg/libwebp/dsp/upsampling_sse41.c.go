...
#define PACK_AND_STORE(a, b, da, db, out)                       \
  for {                                                          \
    ...
    _mm_store_si128(((__*m128i)(out)) + 0, t_1);                \
    _mm_store_si128(((__*m128i)(out)) + 1, t_2);                \
  } while (0)
...
func Upsample32Pixels_SSE41(/* const */ /* const */ r *uint81, /*const*/ /* const */ r *uint82, /* const */ out *uint8) {
