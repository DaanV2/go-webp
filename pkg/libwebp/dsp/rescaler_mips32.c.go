...
func ImportRowShrink_MIPS32(/* const */ wrk *WebPRescaler, /*const*/ src *uint8) {
  x_stride := wrk.num_channels;
  x_out_max := wrk.dst_width * wrk.num_channels;
  fx_scale := wrk.fx_scale;
  x_add := wrk.x_add;
  x_sub := wrk.x_sub;
  x_stride1 := x_stride << 2;
  var channel int
...
func ImportRowExpand_MIPS32(/* const */ wrk *WebPRescaler, /*const*/ src *uint8) {
  x_stride := wrk.num_channels;
  x_out_max := wrk.dst_width * wrk.num_channels;
  x_add := wrk.x_add;
  x_sub := wrk.x_sub;
