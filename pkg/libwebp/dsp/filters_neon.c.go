...
func PredictLine_NEON(/* const */ src *uint8, /*const*/ pred *uint8, dst *uint8, length int) {
  var i int
...
func PredictLineLeft_NEON(/* const */ src *uint8, dst *uint8, length int) {
...
static  func DoHorizontalFilter_NEON(/* const */ in *uint8, width, height int, stride int, out *uint8) {
  row int;
  DCHECK(in, out);
...
func HorizontalFilter_NEON(/* const */ data *uint8, width, height int, stride int, filtered_data *uint8) {
...
static  func DoVerticalFilter_NEON(/* const */ in *uint8, width, height int, stride int, out *uint8) {
  row int;
  DCHECK(in, out);
...
func VerticalFilter_NEON(/* const */ data *uint8, width, height int, stride int, filtered_data *uint8) {
...
func GradientPredictDirect_NEON(/* const */ row *uint8, /*const*/ top *uint8, /* const */ out *uint8, length int) {
  var i int
...
static  func DoGradientFilter_NEON(/* const */ in *uint8, width, height int, stride int, out *uint8) {
  row int;
  DCHECK(in, out);
...
func GradientFilter_NEON(/* const */ data *uint8, width, height int, stride int, filtered_data *uint8) {
