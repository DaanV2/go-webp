...
func PredictLine_NEON(/* const */ src *uint8, /*const*/ pred *uint8, WEBP_RESTRICT dst *uint8, length int) {
  var i int
...
func PredictLineLeft_NEON(/* const */ WEBP_RESTRICT src *uint8, WEBP_RESTRICT dst *uint8, length int) {
...
static  func DoHorizontalFilter_NEON(/* const */ WEBP_RESTRICT in *uint8, width, height int, stride int, WEBP_RESTRICT out *uint8) {
  row int;
  DCHECK(in, out);
...
func HorizontalFilter_NEON(/* const */ WEBP_RESTRICT data *uint8, width, height int, stride int, WEBP_RESTRICT filtered_data *uint8) {
...
static  func DoVerticalFilter_NEON(/* const */ WEBP_RESTRICT in *uint8, width, height int, stride int, WEBP_RESTRICT out *uint8) {
  row int;
  DCHECK(in, out);
...
func VerticalFilter_NEON(/* const */ WEBP_RESTRICT data *uint8, width, height int, stride int, WEBP_RESTRICT filtered_data *uint8) {
...
func GradientPredictDirect_NEON(/* const */ row *uint8, /*const*/ top *uint8, WEBP_RESTRICT const out *uint8, length int) {
  var i int
...
static  func DoGradientFilter_NEON(/* const */ WEBP_RESTRICT in *uint8, width, height int, stride int, WEBP_RESTRICT out *uint8) {
  row int;
  DCHECK(in, out);
...
func GradientFilter_NEON(/* const */ WEBP_RESTRICT data *uint8, width, height int, stride int, WEBP_RESTRICT filtered_data *uint8) {
...
func HorizontalUnfilter_NEON(/* const */ prev *uint8, /*const*/ in *uint8, out *uint8, width int) {
  var i int
...
func VerticalUnfilter_NEON(/* const */ prev *uint8, /*const*/ in *uint8, out *uint8, width int) {
  if (prev == nil) {
...
func GradientPredictInverse_NEON(/* const */ in *uint8, /*const*/ top *uint8, /*const*/ row *uint8, length int) {
  if (length > 0) {
    var i int
...
func GradientUnfilter_NEON(/* const */ prev *uint8, /*const*/ in *uint8, out *uint8, width int) {
  if (prev == nil) {
    HorizontalUnfilter_NEON(nil, in, out, width);
  } else {
