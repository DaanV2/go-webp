...
typedef func (*VP8LPredictorAddSubFunc)(const uint32_t* in,
...
typedef func (*VP8LProcessDecBlueAndRedFunc)(const uint32_t* src,
...
typedef func (*VP8LConvertFunc)(const uint32_t* WEBP_RESTRICT src,
...
typedef func (*VP8LMapARGBFunc)(const uint32_t* src,
                                const uint32_t* const color_map, uint32_t* dst,
                                int y_start, int y_end, int width);
typedef func (*VP8LMapAlphaFunc)(const uint8_t* src,
...
typedef func (*VP8LProcessEncBlueAndRedFunc)(uint32_t* dst, int num_pixels);
...
typedef func (*VP8LAddVectorFunc)(const uint32_t* WEBP_RESTRICT a,
                                  const uint32_t* WEBP_RESTRICT b,
                                  uint32_t* WEBP_RESTRICT out, int size);
extern VP8LAddVectorFunc VP8LAddVector;
typedef func (*VP8LAddVectorEqFunc)(const uint32_t* WEBP_RESTRICT a,
                                    uint32_t* WEBP_RESTRICT out, int size);
...
typedef func (*VP8LBundleColorMapFunc)(const uint8_t* WEBP_RESTRICT const row,
                                       int width, int xbits,
