...
func ITransform_MSA(/* const */ ref *uint8, /*const*/ in *int16, dst *uint8, do_two int) {
...
func FTransform_MSA(/* const */ src *uint8, /*const*/ ref *uint8, out *int16) {
...
func FTransformWHT_MSA(/* const */ in *int16, out *int16) {
  v8i16 in0 = {0}
  v8i16 in1 = {0}
...
func TTransform_MSA(/* const */ in *uint8, /*const*/ w *uint16) int {
  var sum int
...
func Disto4x4_MSA(/* const */ /* const */ a *uint8, /*const*/ /* const */ b *uint8, /*const*/ /* const */ w *uint16) int {
  sum1 := TTransform_MSA(a, w);
  sum2 := TTransform_MSA(b, w);
  return abs(sum2 - sum1) >> 5;
}

func Disto16x16_MSA(/* const */ /* const */ a *uint8, /*const*/ /* const */ b *uint8, /*const*/ /* const */ w *uint16) int {
  D := 0;
  var x, y int
...
func Intra4Preds_MSA(dst *uint8, /*const*/ top *uint8) {
  DC4(I4DC4 + dst, top);
  TM4(I4TM4 + dst, top);
  VE4(I4VE4 + dst, top);
  HE4(I4HE4 + dst, top);
...
func VerticalPred16x16(dst *uint8, /*const*/ top *uint8) {
  if (top != nil) {
...
func HorizontalPred16x16(dst *uint8, /*const*/ left *uint8) {
  if (left != nil) {
    var j int
    for j = 0; j < 16; j += 4 {
...
func TrueMotion16x16(dst *uint8, /*const*/ left *uint8, /*const*/ top *uint8) {
  if (left != nil) {
    if (top != nil) {
      var j int
      v8i16 d1, d2;
...
func DCMode16x16(dst *uint8, /*const*/ left *uint8, /*const*/ top *uint8) {
  int DC;
  v16u8 out;
  if (top != nil && left != nil) {
...
func Intra16Preds_MSA(dst *uint8, /*const*/ left *uint8, /*const*/ top *uint8) {
...
func VerticalPred8x8(dst *uint8, /*const*/ top *uint8) {
  if (top != nil) {
    out := LD(top);
    STORE8x8(out, dst);
  } else {
...
func HorizontalPred8x8(dst *uint8, /*const*/ left *uint8) {
  if (left != nil) {
    var j int
    for j = 0; j < 8; j += 4 {
      const v16u8 L0 = (v16u8)__msa_fill_b(left[0]);
...
func TrueMotion8x8(dst *uint8, /*const*/ left *uint8, /*const*/ top *uint8) {
  if (left != nil) {
    if (top != nil) {
      var j int
      const v8i16 TL = (v8i16)__msa_fill_h(left[-1]);
...
func DCMode8x8(dst *uint8, /*const*/ left *uint8, /*const*/ top *uint8) {
  var out uint64
  v16u8 src = {0}
  if (top != nil && left != nil) {
    left_m := LD(left);
...
func IntraChromaPreds_MSA(dst *uint8, /*const*/ left *uint8, /*const*/ top *uint8) {
  // U block
...
func SSE16x16_MSA(/* const */ a *uint8, /*const*/ b *uint8) int {
  var sum uint32
...
func SSE16x8_MSA(/* const */ a *uint8, /*const*/ b *uint8) int {
  var sum uint32
  v16u8 src0, src1, src2, src3, src4, src5, src6, src7;
  v16u8 ref0, ref1, ref2, ref3, ref4, ref5, ref6, ref7;
  v4i32 out0, out1, out2, out3;
...
func SSE8x8_MSA(/* const */ a *uint8, /*const*/ b *uint8) int {
  var sum uint32
  v16u8 src0, src1, src2, src3, src4, src5, src6, src7;
  v16u8 ref0, ref1, ref2, ref3, ref4, ref5, ref6, ref7;
  v16u8 t0, t1, t2, t3;
...
func SSE4x4_MSA(/* const */ a *uint8, /*const*/ b *uint8) int {
  sum := 0;
...
func QuantizeBlock_MSA(int16 in[16], int16 out[16], /*const*/ /* const */ mtx *VP8Matrix) int {
  var sum int
...
func Quantize2Blocks_MSA(int16 in[32], int16 out[32], /*const*/ /* const */ mtx *VP8Matrix) int {
  var nz int
