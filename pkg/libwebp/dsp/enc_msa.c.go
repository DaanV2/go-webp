...
func Intra4Preds_MSA(WEBP_RESTRICT dst *uint8, /*const*/ WEBP_RESTRICT top *uint8) {
  DC4(I4DC4 + dst, top);
  TM4(I4TM4 + dst, top);
  VE4(I4VE4 + dst, top);
  HE4(I4HE4 + dst, top);
...
func VerticalPred16x16(WEBP_RESTRICT dst *uint8, /*const*/ WEBP_RESTRICT top *uint8) {
  if (top != nil) {
...
func HorizontalPred16x16(WEBP_RESTRICT dst *uint8, /*const*/ WEBP_RESTRICT left *uint8) {
  if (left != nil) {
    var j int
    for j = 0; j < 16; j += 4 {
...
func TrueMotion16x16(WEBP_RESTRICT dst *uint8, /*const*/ WEBP_RESTRICT left *uint8, /*const*/ WEBP_RESTRICT top *uint8) {
  if (left != nil) {
    if (top != nil) {
      var j int
      v8i16 d1, d2;
...
func DCMode16x16(WEBP_RESTRICT dst *uint8, /*const*/ WEBP_RESTRICT left *uint8, /*const*/ WEBP_RESTRICT top *uint8) {
  int DC;
  v16u8 out;
  if (top != nil && left != nil) {
...
func Intra16Preds_MSA(WEBP_RESTRICT dst *uint8, /*const*/ WEBP_RESTRICT left *uint8, /*const*/ WEBP_RESTRICT top *uint8) {
...
func VerticalPred8x8(WEBP_RESTRICT dst *uint8, /*const*/ WEBP_RESTRICT top *uint8) {
  if (top != nil) {
    out := LD(top);
    STORE8x8(out, dst);
  } else {
...
func HorizontalPred8x8(WEBP_RESTRICT dst *uint8, /*const*/ WEBP_RESTRICT left *uint8) {
  if (left != nil) {
    var j int
    for j = 0; j < 8; j += 4 {
      const v16u8 L0 = (v16u8)__msa_fill_b(left[0]);
...
func TrueMotion8x8(WEBP_RESTRICT dst *uint8, /*const*/ WEBP_RESTRICT left *uint8, /*const*/ WEBP_RESTRICT top *uint8) {
  if (left != nil) {
    if (top != nil) {
      var j int
      const v8i16 TL = (v8i16)__msa_fill_h(left[-1]);
...
func DCMode8x8(WEBP_RESTRICT dst *uint8, /*const*/ WEBP_RESTRICT left *uint8, /*const*/ WEBP_RESTRICT top *uint8) {
  var out uint64
  v16u8 src = {0}
  if (top != nil && left != nil) {
    left_m := LD(left);
...
func IntraChromaPreds_MSA(WEBP_RESTRICT dst *uint8, /*const*/ WEBP_RESTRICT left *uint8, /*const*/ WEBP_RESTRICT top *uint8) {
  // U block
