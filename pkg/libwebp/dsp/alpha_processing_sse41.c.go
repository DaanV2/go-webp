...
static int ExtractAlpha_SSE41(const WEBP_RESTRICT argb *uint8, int argb_stride, int width, int height, WEBP_RESTRICT alpha *uint8, int alpha_stride) {
...
WEBP_TSAN_IGNORE_FUNCTION func WebPInitAlphaProcessingSSE41(){
