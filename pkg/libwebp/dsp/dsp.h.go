...
type VP8Metric = func(/* const */ pix []uint8, /*const*/ ref []uint8)int
type VP8WMetric = func(/* const */ pix []uint8, /*const*/ ref []uint8, /*const*/ /* const */ weights []uint16)int

// Compute the average (DC) of four 4x4 blocks.
// Each sub-4x4 block #i sum is stored in dc[i].
type VP8MeanMetric = func(/* const */ ref []uint8, dc [4]uint32)


type VP8BlockCopy = func(/* const */ src []uint8, dst []uint8)


type VP8QuantizeBlock = func( in [16]int16, out [16]int16, /*const*/ mtx *VP8Matrix) int 
// Same as VP8QuantizeBlock, but quantizes two consecutive blocks.
type VP8Quantize2Blocks = func(in [32]int16, out [32]int16, /*const*/ mtx *VP8Matrix) int 




// specific to 2nd transform:
type VP8QuantizeBlockWHT = func (in [16]int16, out [16]int16, /*const*/ mtx *VP8Matrix) int
...
// 8bit fixed-point log(p)
// approximate cost per level:
var VP8EntropyCost [256]uint16  
var VP8LevelFixedCosts [2047 /*MAX_LEVEL*/ + 1]uint16
var VP8EncBands [16 + 1]uint8

type VP8SetResidualCoeffsFunc = func(coeffs *int16, res *VP8Residual)


// Cost calculation function.
type VP8GetResidualCostFunc = func(ctx0 int , res *VP8Residual) int
