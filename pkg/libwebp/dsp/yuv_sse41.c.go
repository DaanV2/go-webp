...
func ConvertYUV444ToRGB_SSE41(const __*m128i const Y0, const __*m128i const U0, const __*m128i const V0, __*m128i const R, __*m128i const G, __*m128i const B) {
...
static  __m128i Load_HI_16_SSE41(const *uint8 src) {
  const __m128i zero = _mm_setzero_si128();
  return _mm_unpacklo_epi8(zero, _mm_loadl_epi64((const __*m128i)src));
}

// Load and replicate the U/V samples
static  __m128i Load_UV_HI_8_SSE41(const *uint8 src) {
  const __m128i zero = _mm_setzero_si128();
...
func YUV444ToRGB_SSE41(const *uint8 WEBP_RESTRICT const y, const *uint8 WEBP_RESTRICT const u, const *uint8 WEBP_RESTRICT const v, __*m128i const R, __*m128i const G, __*m128i const B) {
...
func YUV420ToRGB_SSE41(const *uint8 WEBP_RESTRICT const y, const *uint8 WEBP_RESTRICT const u, const *uint8 WEBP_RESTRICT const v, __*m128i const R, __*m128i const G, __*m128i const B) {
...
static  func PlanarTo24b_SSE41(
    __*m128i const in0, __*m128i const in1, __*m128i const in2, __*m128i const in3, __*m128i const in4, __*m128i const in5, *uint8 WEBP_RESTRICT const rgb) {
...
func VP8YuvToRgb32_SSE41(const *uint8 WEBP_RESTRICT y, const *uint8 WEBP_RESTRICT u, const *uint8 WEBP_RESTRICT v, *uint8 WEBP_RESTRICT dst) {
...
func VP8YuvToBgr32_SSE41(const *uint8 WEBP_RESTRICT y, const *uint8 WEBP_RESTRICT u, const *uint8 WEBP_RESTRICT v, *uint8 WEBP_RESTRICT dst) {
  __m128i R0, R1, R2, R3, G0, G1, G2, G3, B0, B1, B2, B3;
...
func YuvToRgbRow_SSE41(const *uint8 WEBP_RESTRICT y, const *uint8 WEBP_RESTRICT u, const *uint8 WEBP_RESTRICT v, *uint8 WEBP_RESTRICT dst, int len) {
  int n;
...
func YuvToBgrRow_SSE41(const *uint8 WEBP_RESTRICT y, const *uint8 WEBP_RESTRICT u, const *uint8 WEBP_RESTRICT v, *uint8 WEBP_RESTRICT dst, int len) {
  int n;
  for (n = 0; n + 32 <= len; n += 32, dst += 32 * 3) {
    __m128i R0, R1, R2, R3, G0, G1, G2, G3, B0, B1, B2, B3;
    __m128i bgr0, bgr1, bgr2, bgr3, bgr4, bgr5;
...
static  func RGBPackedToPlanar_SSE41(
    const *uint8 WEBP_RESTRICT const rgb, __*m128i const out /*out[6]*/) {
  const __m128i A0 = _mm_loadu_si128((const __*m128i)(rgb + 0));
  const __m128i A1 = _mm_loadu_si128((const __*m128i)(rgb + 16));
  const __m128i A2 = _mm_loadu_si128((const __*m128i)(rgb + 32));
  const __m128i A3 = _mm_loadu_si128((const __*m128i)(rgb + 48));
  const __m128i A4 = _mm_loadu_si128((const __*m128i)(rgb + 64));
  const __m128i A5 = _mm_loadu_si128((const __*m128i)(rgb + 80));
...
static  func RGBAPackedToRGBPlanar_SSE41(
...
static  func ARGBPackedToRGBPlanar16_SSE41(
    const *uint32 WEBP_RESTRICT const argb, __*m128i const rgb /*in[6]*/) {
  const __m128i zero = _mm_setzero_si128();
  __m128i a0 = _mm_loadu_si128((const __*m128i)(argb + 0));
  __m128i a1 = _mm_loadu_si128((const __*m128i)(argb + 4));
  __m128i a2 = _mm_loadu_si128((const __*m128i)(argb + 8));
  __m128i a3 = _mm_loadu_si128((const __*m128i)(argb + 12));
  VP8L32bToPlanar_SSE41(&a0, &a1, &a2, &a3);
...
static  func ConvertRGBToYImpl_SSE41(const __*m128i const R, const __*m128i const G, const __*m128i const B, __*m128i const Y) {
...
static  func ConvertRGBToUV_SSE41(const __*m128i const R, const __*m128i const G, const __*m128i const B, __*m128i const U, __*m128i const V) {
...
func ConvertRGBToY_SSE41(const *uint8 WEBP_RESTRICT rgb, *uint8 WEBP_RESTRICT y, int width, int step) {
...
func ConvertBGRToY_SSE41(const *uint8 WEBP_RESTRICT bgr, *uint8 WEBP_RESTRICT y, int width, int step) {
  const int max_width = width & ~31;
  int i;
  __m128i bgr_plane[6];
  if (step == 3) {
...
func ConvertARGBToY_SSE41(const *uint32 WEBP_RESTRICT argb, *uint8 WEBP_RESTRICT y, int width) {
...
func HorizontalAddPack_SSE41(const __*m128i const A, const __*m128i const B, __*m128i const out) {
...
func ConvertARGBToUV_SSE41(const *uint32 WEBP_RESTRICT argb, *uint8 WEBP_RESTRICT u, *uint8 WEBP_RESTRICT v, int src_width, int do_store) {
...
static  func RGBA32PackedToPlanar_16b_SSE41(
...
func ConvertRGBA32ToUV_SSE41(const *uint16 WEBP_RESTRICT rgb, *uint8 WEBP_RESTRICT u, *uint8 WEBP_RESTRICT v, int width) {
  const int max_width = width & ~15;
