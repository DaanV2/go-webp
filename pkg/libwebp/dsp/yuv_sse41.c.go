...
func ConvertYUV444ToRGB_SSE41(const __m128i* const Y0, const __m128i* const U0, const __m128i* const V0, __m128i* const R, __m128i* const G, __m128i* const B) {
...
func YUV444ToRGB_SSE41(const uint8* WEBP_RESTRICT const y, const uint8* WEBP_RESTRICT const u, const uint8* WEBP_RESTRICT const v, __m128i* const R, __m128i* const G, __m128i* const B) {
...
func YUV420ToRGB_SSE41(const uint8* WEBP_RESTRICT const y, const uint8* WEBP_RESTRICT const u, const uint8* WEBP_RESTRICT const v, __m128i* const R, __m128i* const G, __m128i* const B) {
...
static  func PlanarTo24b_SSE41(
    __m128i* const in0, __m128i* const in1, __m128i* const in2, __m128i* const in3, __m128i* const in4, __m128i* const in5, uint8* WEBP_RESTRICT const rgb) {
...
static  func ConvertRGBToYImpl_SSE41(const __m128i* const R, const __m128i* const G, const __m128i* const B, __m128i* const Y) {
...
static  func ConvertRGBToUV_SSE41(const __m128i* const R, const __m128i* const G, const __m128i* const B, __m128i* const U, __m128i* const V) {
...
func HorizontalAddPack_SSE41(const __m128i* const A, const __m128i* const B, __m128i* const out) {
