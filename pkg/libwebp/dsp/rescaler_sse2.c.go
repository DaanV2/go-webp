...
func RescalerImportRowExpand_SSE2(/* const */ wrk *WebPRescaler, /*const*/ src *uint8) {
...
func RescalerImportRowShrink_SSE2(/* const */ wrk *WebPRescaler, /*const*/ src *uint8) {
  x_sub := wrk.x_sub;
  accum := 0;
  const __m128i zero = _mm_setzero_si128();
...
static  func LoadDispatchAndMult_SSE2(
    const rescaler_t* /* const */ src, /*const*/ __const mult *m128i, __const out *m128i0, __const out *m128i1, __const out *m128i2, __const out *m128i3) {
