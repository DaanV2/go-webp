...
func PredictorAdd0_NEON(/* const */ in *uint32, /*const*/ upper *uint32, num_pixels int, out *uint32) {
  var i int
...
// Predictor1: left.
func PredictorAdd1_NEON(/* const */ in *uint32, /*const*/ upper *uint32, num_pixels int, out *uint32) {
  var i int
...
func PredictorAdd5_NEON(/* const */ in *uint32, /*const*/ upper *uint32, num_pixels int, out *uint32) {
  var i int
...
func PredictorAdd6_NEON(/* const */ in *uint32, /*const*/ upper *uint32, num_pixels int, out *uint32) {
  var i int
  uint8x16_t L = LOADQ_U32_AS_U8(out[-1]);
  for i = 0; i + 4 <= num_pixels; i += 4 {
    const uint8x16_t src = LOADQ_U32P_AS_U8(&in[i]);
...
func PredictorAdd7_NEON(/* const */ in *uint32, /*const*/ upper *uint32, num_pixels int, out *uint32) {
  var i int
  uint8x16_t L = LOADQ_U32_AS_U8(out[-1]);
  for i = 0; i + 4 <= num_pixels; i += 4 {
    const uint8x16_t src = LOADQ_U32P_AS_U8(&in[i]);
...
func PredictorAdd10_NEON(/* const */ in *uint32, /*const*/ upper *uint32, num_pixels int, out *uint32) {
  var i int
  uint8x16_t L = LOADQ_U32_AS_U8(out[-1]);
  for i = 0; i + 4 <= num_pixels; i += 4 {
    const uint8x16_t src = LOADQ_U32P_AS_U8(&in[i]);
...
func PredictorAdd11_NEON(/* const */ in *uint32, /*const*/ upper *uint32, num_pixels int, out *uint32) {
  var i int
  uint8x16_t L = LOADQ_U32_AS_U8(out[-1]);
  for i = 0; i + 4 <= num_pixels; i += 4 {
    const uint8x16_t T = LOADQ_U32P_AS_U8(&upper[i]);
...
func PredictorAdd12_NEON(/* const */ in *uint32, /*const*/ upper *uint32, num_pixels int, out *uint32) {
  var i int
...
func PredictorAdd13_NEON(/* const */ in *uint32, /*const*/ upper *uint32, num_pixels int, out *uint32) {
  var i int
  uint8x16_t L = LOADQ_U32_AS_U8(out[-1]);
  for i = 0; i + 4 <= num_pixels; i += 4 {
    const uint8x16_t src = LOADQ_U32P_AS_U8(&in[i]);
