...
func SubtractGreenFromBlueAndRed_AVX2(argb_data *uint32, num_pixels int) {
  var i int
  ...
  for i = 0; i + 8 <= num_pixels; i += 8 {
    const __m256i in = _mm256_loadu_si256((__*m256i)&argb_data[i]);  // argb
    const __m256i in_0g0g = _mm256_shuffle_epi8(in, kCstShuffle);
    const __m256i out = _mm256_sub_epi8(in, in_0g0g);
    _mm256_storeu_si256((__*m256i)&argb_data[i], out);
  }
...
func TransformColor_AVX2(/* const */ WEBP_RESTRICT const m *VP8LMultipliers, WEBP_RESTRICT argb_data *uint32, num_pixels int) {
  ...
  const __m256i kCstShuffle = _mm256_set_epi8(
      29, -1, 29, -1, 25, -1, 25, -1, 21, -1, 21, -1, 17, -1, 17, -1, 13, -1, 13, -1, 9, -1, 9, -1, 5, -1, 5, -1, 1, -1, 1, -1);
  var i int
  for i = 0; i + 8 <= num_pixels; i += 8 {
    const __m256i in = _mm256_loadu_si256((__*m256i)&argb_data[i]);  // argb
...
func AddVector_AVX2(/* const */ WEBP_RESTRICT a *uint32, /*const*/ WEBP_RESTRICT b *uint32, WEBP_RESTRICT out *uint32, size int) {
  ...
  for {
    ...
    _mm256_storeu_si256((__*m256i)&out[i + 24], _mm256_add_epi32(a3, b3));
    i += 32;
  ...
  switch (xbits) {
    case 0: {
      ...
      for x = 0; x + 32 <= width; x += 32, dst += 32 {
        ...
        _mm256_storeu2_m128i((__*m128i)&dst[16], (__*m128i)&dst[0], dst0);
        _mm256_storeu2_m128i((__*m128i)&dst[20], (__*m128i)&dst[4], dst1);
        _mm256_storeu2_m128i((__*m128i)&dst[24], (__*m128i)&dst[8], dst2);
        _mm256_storeu2_m128i((__*m128i)&dst[28], (__*m128i)&dst[12], dst3);
      }
      break;
    }
    case 1: {
      ...
      for x = 0; x + 32 <= width; x += 32, dst += 16 {
        ...
        _mm256_storeu2_m128i((__*m128i)&dst[8], (__*m128i)&dst[0], dst0);
        _mm256_storeu2_m128i((__*m128i)&dst[12], (__*m128i)&dst[4], dst1);
      }
      break;
    }
    case 2: {
      ...
      for x = 0; x + 32 <= width; x += 32, dst += 8 {
        ...
        _mm256_storeu_si256((__*m256i)dst, res);
      }
      break;
    }
    default: {
