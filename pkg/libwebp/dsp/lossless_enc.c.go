...
var kLog2Table = [LOG_LOOKUP_IDX_MAX]uint32{
...
//                      for i in a],4)]))
var kSLog2Table = [LOG_LOOKUP_IDX_MAX]uint64{
    uint64(0),
	uint64(0),
...
var kPrefixEncodeCode = [PREFIX_LOOKUP_IDX_MAX]VP8LPrefixCode{
...
var kPrefixEncodeExtraBitsValue = [PREFIX_LOOKUP_IDX_MAX]uint8{
