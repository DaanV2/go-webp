...
func PredictLineInverse0(/* const */ src *uint8, /*const*/ pred *uint8, WEBP_RESTRICT dst *uint8, int length) {
...
func PredictLineGradient(/* const */ pinput *uint8, /*const*/ ppred *uint8, WEBP_RESTRICT poutput *uint8, int stride, size int) {
  var w int
  const v16i8 zero = {0}
  while (size >= 16) {
    v16u8 pred0, dst0;
